...
import com.itextpdf.html2pdf.jsoup.PortUtil;
import com.itextpdf.html2pdf.jsoup.nodes.DocumentType;
import com.itextpdf.html2pdf.jsoup.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<com.itextpdf.html2pdf.jsoup.nodes.Attribute> values = element.attributes().asList();
            for (com.itextpdf.html2pdf.jsoup.nodes.Attribute attribute : values) {
