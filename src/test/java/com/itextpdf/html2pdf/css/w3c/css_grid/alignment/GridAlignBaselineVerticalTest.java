...
@LogMessages(messages = {
        @LogMessage(messageTemplate = Html2PdfLogMessageConstant.NO_WORKER_FOUND_FOR_TAG, count = 5)})
public class GridAlignBaselineVerticalTest extends W3CCssGridTest {
    @Override
