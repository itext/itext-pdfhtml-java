...
@LogMessages(messages = {
        @LogMessage(messageTemplate = Html2PdfLogMessageConstant.INVALID_CSS_PROPERTY_DECLARATION, count = 5),
        @LogMessage(messageTemplate = Html2PdfLogMessageConstant.NO_WORKER_FOUND_FOR_TAG)})
public class FileControlCrashTest extends W3CCssMulticolTest {
    @Override
