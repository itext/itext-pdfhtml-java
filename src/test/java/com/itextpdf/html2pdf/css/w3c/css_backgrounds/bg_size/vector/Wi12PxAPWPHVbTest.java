...
@LogMessages(messages = {
        @LogMessage(messageTemplate = StyledXmlParserLogMessageConstant.UNKNOWN_ABSOLUTE_METRIC_LENGTH_PARSED, count = 9)
})
public class Wi12PxAPWPHVbTest extends W3CCssTest {
    @Override
    protected String getHtmlFileName() {
        return "wide--12px-auto--percent-width-percent-height-viewbox.html";
    }
}
