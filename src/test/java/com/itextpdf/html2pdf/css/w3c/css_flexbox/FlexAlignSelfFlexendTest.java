...
//TODO DEVSIX-5166 change after align-self: flex-end is implemented
@LogMessages(messages = @LogMessage(messageTemplate = Html2PdfLogMessageConstant.FLEX_PROPERTY_IS_NOT_SUPPORTED_YET))
public class FlexAlignSelfFlexendTest extends W3CCssTest {
    @Override
    protected String getHtmlFileName() {
        return "flexbox_align-self-flexend.html";
    }
}
