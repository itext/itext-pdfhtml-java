...
public class VerticalTextCornerCasesTest extends ExtendedHtmlConversionITextTest {
    ...
    public static final String SOURCE_FOLDER = "./src/test/resources/com/itextpdf/html2pdf/css/VerticalTextCornerCasesTest/";
    public static final String DESTINATION_FOLDER = "./target/test/com/itextpdf/html2pdf/css/VerticalTextCornerCasesTest/";
