...
public class HtmlTest extends ExtendedITextTest {
    ...
    public void html01Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest01.pdf", sourceFolder + "cmp_htmlTest01.pdf", destinationFolder, "diff01_"));
    }
    ...
    public void html02Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest02.pdf", sourceFolder + "cmp_htmlTest02.pdf", destinationFolder, "diff02_"));
    }
    ...
    public void html03Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest03.pdf", sourceFolder + "cmp_htmlTest03.pdf", destinationFolder, "diff03_"));
    }
    ...
    public void html04Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest04.pdf", sourceFolder + "cmp_htmlTest04.pdf", destinationFolder, "diff04_"));
    }
    ...
    public void html05Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest05.pdf", sourceFolder + "cmp_htmlTest05.pdf", destinationFolder, "diff05_"));
    }
    ...
    public void html06Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest06.pdf", sourceFolder + "cmp_htmlTest06.pdf", destinationFolder, "diff06_"));
    }
    ...
    public void html07Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest07.pdf", sourceFolder + "cmp_htmlTest07.pdf", destinationFolder, "diff07_"));
    }
    ...
    public void html08Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest08.pdf", sourceFolder + "cmp_htmlTest08.pdf", destinationFolder, "diff08_"));
    }
    ...
    public void html09Test() throws IOException, InterruptedException {
        ...
        Assertions.assertNull(new CompareTool().compareByContent(destinationFolder + "htmlTest09.pdf", sourceFolder + "cmp_htmlTest09.pdf", destinationFolder, "diff09_"));
    }
}
