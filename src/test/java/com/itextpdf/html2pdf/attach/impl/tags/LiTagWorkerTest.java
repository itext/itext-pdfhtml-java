...
public class LiTagWorkerTest extends ExtendedITextTest {

    @Test
    public void langAttrInLiForTaggedPdfTest() {
        Attributes attributes = new Attributes();
        attributes.put(AttributeConstants.LANG, "en");
        Element element = new Element(Tag.valueOf(TagConstants.LI), TagConstants.LI, attributes);
