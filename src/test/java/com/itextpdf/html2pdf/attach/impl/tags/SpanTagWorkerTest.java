...
public class SpanTagWorkerTest extends ExtendedITextTest {

    @Test
    public void langAttrInSpanForTaggedPdfTest() {
        Attributes attributes = new Attributes();
        attributes.put(AttributeConstants.LANG, "en");
        Element element = new Element(Tag.valueOf(TagConstants.SPAN), TagConstants.SPAN, attributes);
